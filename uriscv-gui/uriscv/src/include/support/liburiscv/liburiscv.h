...
/*
 * External declarations for uRISCV library module.
 */
...
extern unsigned int SYSCALL(unsigned int number, unsigned int arg1,
...
extern unsigned int LDCXT(unsigned int stackPtr, unsigned int status,
                          unsigned int pc);
