...
service to the SSI. Important: Level 4/Phase 3 exception handlers are limited in their interaction with the Nucleus and its data structures to the functionality of SYSCALLs identified by
...
6. Pick a frame, i, from the Swap Pool. Which frame is selected is determined by the µPandOS
